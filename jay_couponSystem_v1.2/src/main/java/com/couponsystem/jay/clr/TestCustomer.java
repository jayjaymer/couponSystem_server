...
public class TestCustomer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("check if customer is exists");
		System.out.println(customerService.checkIfCustomer("customer2@gmail.com", "1234"));

		System.out.println("get customer info by email and password");
		System.out.println(customerService.getOneCustomerByEmailAndPassword("customer2@gmail.com", "1234"));
